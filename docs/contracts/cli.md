...
- Справка, подписи text-отчётов и сообщения, созданные Go CLI, всегда выводятся
  на английском. Заголовки и другие значения из исходных документов не
  переводятся; `--lang ru` и русские metadata aliases продолжают работать.
