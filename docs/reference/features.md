...
выделенному тексту. На странице документа ветки открываются в собственной
адаптивной панели без перехода в «Изменения». Кнопка «Отправить агенту» только
фиксирует пакет; агента нужно попросить отдельно. Ответ не закрывает обсуждение
автоматически.
