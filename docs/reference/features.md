...
документу Markdown или диапазону. Черновик редактируется и удаляется; «Добавить в очередь»
создаёт одну неизменяемую запись, а «Скопировать промт» только копирует
просьбу агенту. Ответ не закрывает обсуждение автоматически.
