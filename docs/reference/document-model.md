...
определяет вид документа, какие идентификаторы и связи распознаёт Toudocu и
...
Toudocu проверяет только явно заявленные обещания:
...
В колонке «Обратная сторона» указано, создаёт ли Toudocu обратную связь в
...
Toudocu вычисляет представления только из канонических Markdown-источников:
...
Toudocu не угадывает применимость стандартов по glob и не создаёт продуктовые
