# UC-AGENT-01: Установить AI-skill Docu-docu

- Идентификатор: UC-AGENT-01
- Статус: Готово
- Актор: Пользователь Docu-docu
- Модуль: MOD-CLI
- Приоритет: Высокий
- Последнее обновление: 2026-08-06

Пользователь устанавливает встроенный offline-пакет skill `docu-docu` в
...
1. Пользователь предварительно вызывает `docu-docu skill status` или сразу
