...
Модуль предоставляет команды Docgent и детерминированный workflow от поиска и
...
### BR-CLI-004: Docgent не интерпретирует пользовательский запрос

Docgent создаёт нейтральные каркасы и проверяет структуру. Выбор сущностей,
