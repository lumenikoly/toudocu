...
Canonical `docu-docu serve` неблокирующе проверяет последний
...
Пользователь узнаёт о новом релизе только вне Docu-docu или вручную
...
- [x] `AC-02` `GET|HEAD /_docu-docu/api/version` отдаёт schema v1,
