...
- [x] `AC-03` Единая локальная команда проверяет форматирование, Go-код,
  race detector, модули и оба документационных root.
- [x] `AC-04` Локальный release bundle содержит пять целевых бинарников,
  notices, лицензии и проверяемый `checksums.txt`.
- [x] `AC-05` Исходная документация и оба отслеживаемых портала согласованы с
...
changelog и описание dependency-free поставки. Оба отслеживаемых портала
