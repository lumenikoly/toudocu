...
документы всех основных типов, Mermaid, Screen Map, playable flows, hotspots,
...
затем строит автономную SVG-карту, каталог и playable flows.
...
Playable flow хранит историю, отображает состояния и ошибки, а на terminal
screen позволяет начать заново, открыть карту или исходный use case.
Подробный формат описан в [руководстве](docs/guides/screens.md).
...
Mermaid-диаграммами, картой экранов, playable flows, traceability, тёмной темой
и печатной версией. Рядом сохраняется `report.json` schema v1 с документами,
проектной моделью, screens, transitions и diagnostics. Его можно читать в CI
