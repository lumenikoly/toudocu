...
решения, модули, сценарии и рабочие задачи:
...
тёмной темой и печатной версией. Рядом сохраняется `report.json` с результатами
проверки. Его можно читать в CI или других инструментах.
