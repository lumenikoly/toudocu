...
Use this gate before creating or changing any document. Docgent validates the
...
- Can every entity, relationship, section, and status be explained without
  referring to a template or Docgent diagnostic?
...
Docgent result presented as proof of quality. The reviewer returns `PASS` or
